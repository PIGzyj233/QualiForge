      ...
      {steps.map((step, i) => (
        <div
          ...
          className={cn(
            ...
            compact ? "grid-cols-[24px_1fr_auto]" : "grid-cols-[24px_1fr_1fr_auto]"
          )}
        >
          ...
          {compact ? (
            <div className="flex min-w-0 flex-col gap-1">
              <textarea
                ...
                className="w-full rounded-[var(--radius-sm)] border border-[var(--input)] bg-[var(--card)] px-2 py-1.5 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-[var(--ring)]"
              />
              <textarea
                value={step.expected}
